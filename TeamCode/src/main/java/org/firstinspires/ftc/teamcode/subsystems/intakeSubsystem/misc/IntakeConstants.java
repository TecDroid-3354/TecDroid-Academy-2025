...
public final class IntakeConstants {
    ...
    public static final class MeasureLimits {
        ...
        public static final double gripperMinAngle = 110.0;
        public static final double gripperMaxAngle = 70.0;

        // These constraints define the minimum and maximum permitted angle values for the wrist rotator
        public static final double wristRotatorMinAngle = 110.0;
        public static final double wristRotatorMaxAngle = 70.0;
    }
}
